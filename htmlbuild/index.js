...
Module['FS_createPath']('/assets', 'sounds', true, true);
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 12394, "filename": "/assets/dancesdl.atlas"}, {"start": 12394, "audio": 0, "end": 167430, "filename": "/assets/dancesdl.png"}, {"start": 167430, "audio": 0, "end": 182412, "filename": "/assets/gamedata.txt"}, {"start": 182412, "audio": 0, "end": 204549, "filename": "/assets/living-room-couch-interior-room-584399.jpg"}, {"start": 204549, "audio": 0, "end": 357701, "filename": "/assets/Oswald.ttf"}, {"start": 357701, "audio": 0, "end": 1632097, "filename": "/assets/pixelmplus.ttf"}, {"start": 1632097, "audio": 0, "end": 1633109, "filename": "/assets/texturepackerproj.tpproj"}, {"start": 1633109, "audio": 0, "end": 1633309, "filename": "/assets/wsq.png"}, {"start": 1633309, "audio": 1, "end": 1648215, "filename": "/assets/sounds/A.wav"}, {"start": 1648215, "audio": 1, "end": 1663121, "filename": "/assets/sounds/B.wav"}, {"start": 1663121, "audio": 1, "end": 2809876, "filename": "/assets/sounds/battlesong.ogg"}, {"start": 2809876, "audio": 1, "end": 2812617, "filename": "/assets/sounds/C.wav"}, {"start": 2812617, "audio": 1, "end": 2827523, "filename": "/assets/sounds/D.wav"}, {"start": 2827523, "audio": 1, "end": 2842429, "filename": "/assets/sounds/De.wav"}, {"start": 2842429, "audio": 1, "end": 2857335, "filename": "/assets/sounds/E.wav"}, {"start": 2857335, "audio": 1, "end": 2964167, "filename": "/assets/sounds/enemydamage.wav"}, {"start": 2964167, "audio": 1, "end": 3180639, "filename": "/assets/sounds/enemydead.wav"}, {"start": 3180639, "audio": 1, "end": 3244191, "filename": "/assets/sounds/enemyshoot.wav"}, {"start": 3244191, "audio": 1, "end": 3259097, "filename": "/assets/sounds/F.wav"}, {"start": 3259097, "audio": 1, "end": 3274003, "filename": "/assets/sounds/G.wav"}, {"start": 3274003, "audio": 1, "end": 3664547, "filename": "/assets/sounds/herodamage.wav"}], "remote_package_size": 3664547, "package_uuid": "922f0efa-870a-4059-a6f7-adcd7a07ff99"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 581216,
    DYNAMIC_BASE = 5824096,
    DYNAMICTOP_PTR = 581056;
...
var ASM_CONSTS = {
 ...
 15304: function() {if (navigator.userAgent.includes("Android")) return true; if (navigator.userAgent.includes("iPhone")) return true; if (navigator.userAgent.includes("iPod")) return true; return false;},  
 209860: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 211315: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 212304: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 212397: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 213622: function() {return screen.width;},  
 213649: function() {return screen.height;},  
 213722: function($0) {if (typeof Module['setWindowTitle'] !== 'undefined') { Module['setWindowTitle'](UTF8ToString($0)); } return 0;},  
 213876: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 214042: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
