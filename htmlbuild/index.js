...
Module['FS_createPath']('/assets', 'sounds', true, true);
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 12806, "filename": "/assets/dancesdl.atlas"}, {"start": 12806, "audio": 0, "end": 199221, "filename": "/assets/dancesdl.png"}, {"start": 199221, "audio": 0, "end": 214203, "filename": "/assets/gamedata.txt"}, {"start": 214203, "audio": 0, "end": 236340, "filename": "/assets/living-room-couch-interior-room-584399.jpg"}, {"start": 236340, "audio": 0, "end": 389492, "filename": "/assets/Oswald.ttf"}, {"start": 389492, "audio": 0, "end": 1663888, "filename": "/assets/pixelmplus.ttf"}, {"start": 1663888, "audio": 0, "end": 1664900, "filename": "/assets/texturepackerproj.tpproj"}, {"start": 1664900, "audio": 0, "end": 1665100, "filename": "/assets/wsq.png"}, {"start": 1665100, "audio": 1, "end": 1680006, "filename": "/assets/sounds/A.wav"}, {"start": 1680006, "audio": 1, "end": 1694912, "filename": "/assets/sounds/B.wav"}, {"start": 1694912, "audio": 1, "end": 2841667, "filename": "/assets/sounds/battlesong.ogg"}, {"start": 2841667, "audio": 1, "end": 2844408, "filename": "/assets/sounds/C.wav"}, {"start": 2844408, "audio": 1, "end": 2859314, "filename": "/assets/sounds/D.wav"}, {"start": 2859314, "audio": 1, "end": 2874220, "filename": "/assets/sounds/De.wav"}, {"start": 2874220, "audio": 1, "end": 2889126, "filename": "/assets/sounds/E.wav"}, {"start": 2889126, "audio": 1, "end": 2995958, "filename": "/assets/sounds/enemydamage.wav"}, {"start": 2995958, "audio": 1, "end": 3212430, "filename": "/assets/sounds/enemydead.wav"}, {"start": 3212430, "audio": 1, "end": 3275982, "filename": "/assets/sounds/enemyshoot.wav"}, {"start": 3275982, "audio": 1, "end": 3290888, "filename": "/assets/sounds/F.wav"}, {"start": 3290888, "audio": 1, "end": 3305794, "filename": "/assets/sounds/G.wav"}, {"start": 3305794, "audio": 1, "end": 3696338, "filename": "/assets/sounds/herodamage.wav"}], "remote_package_size": 3696338, "package_uuid": "c02e74f2-b074-4665-9d66-caf7ed14ccf0"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 581296,
    DYNAMIC_BASE = 5824176,
    DYNAMICTOP_PTR = 581136;
...
var ASM_CONSTS = {
 ...
 209940: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 211395: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 212384: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 212477: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 213702: function() {return screen.width;},  
 213729: function() {return screen.height;},  
 213802: function($0) {if (typeof Module['setWindowTitle'] !== 'undefined') { Module['setWindowTitle'](UTF8ToString($0)); } return 0;},  
 213956: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 214122: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
