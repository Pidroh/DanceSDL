...
Module['FS_createPath']('/assets', 'sounds', true, true);
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 13819, "filename": "/assets/dancesdl.atlas"}, {"start": 13819, "audio": 0, "end": 265492, "filename": "/assets/dancesdl.png"}, {"start": 265492, "audio": 0, "end": 280607, "filename": "/assets/gamedata.txt"}, {"start": 280607, "audio": 0, "end": 302744, "filename": "/assets/living-room-couch-interior-room-584399.jpg"}, {"start": 302744, "audio": 0, "end": 455896, "filename": "/assets/Oswald.ttf"}, {"start": 455896, "audio": 0, "end": 1730292, "filename": "/assets/pixelmplus.ttf"}, {"start": 1730292, "audio": 0, "end": 1731304, "filename": "/assets/texturepackerproj.tpproj"}, {"start": 1731304, "audio": 0, "end": 1731504, "filename": "/assets/wsq.png"}, {"start": 1731504, "audio": 1, "end": 1746410, "filename": "/assets/sounds/A.wav"}, {"start": 1746410, "audio": 1, "end": 1761316, "filename": "/assets/sounds/B.wav"}, {"start": 1761316, "audio": 1, "end": 3515014, "filename": "/assets/sounds/battlesong.ogg"}, {"start": 3515014, "audio": 1, "end": 3517755, "filename": "/assets/sounds/C.wav"}, {"start": 3517755, "audio": 1, "end": 3532661, "filename": "/assets/sounds/D.wav"}, {"start": 3532661, "audio": 1, "end": 3547567, "filename": "/assets/sounds/De.wav"}, {"start": 3547567, "audio": 1, "end": 3562473, "filename": "/assets/sounds/E.wav"}, {"start": 3562473, "audio": 1, "end": 3669305, "filename": "/assets/sounds/enemydamage.wav"}, {"start": 3669305, "audio": 1, "end": 3885777, "filename": "/assets/sounds/enemydead.wav"}, {"start": 3885777, "audio": 1, "end": 3949329, "filename": "/assets/sounds/enemyshoot.wav"}, {"start": 3949329, "audio": 1, "end": 3964235, "filename": "/assets/sounds/F.wav"}, {"start": 3964235, "audio": 1, "end": 3979141, "filename": "/assets/sounds/G.wav"}, {"start": 3979141, "audio": 1, "end": 4369685, "filename": "/assets/sounds/herodamage.wav"}], "remote_package_size": 4369685, "package_uuid": "27fdfd6c-16c9-47cf-b6ba-db4822f12b13"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 621712,
    DYNAMIC_BASE = 5864592,
    DYNAMICTOP_PTR = 621552;
...
var ASM_CONSTS = {
 ...
 17527: function($0) {var url = UTF8ToString($0); window.open(url, '_blank');},  
 17717: function() {if (navigator.userAgent.includes("Android")) return true; if (navigator.userAgent.includes("iPhone")) return true; if (navigator.userAgent.includes("iPod")) return true; return false;},  
 210228: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 211683: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 212672: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 212765: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 213990: function() {return screen.width;},  
 214017: function() {return screen.height;},  
 214090: function($0) {if (typeof Module['setWindowTitle'] !== 'undefined') { Module['setWindowTitle'](UTF8ToString($0)); } return 0;},  
 214244: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 214410: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
