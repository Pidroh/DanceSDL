...
Module['FS_createPath']('/assets', 'sounds', true, true);
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 369, "filename": "/assets/dancesdl.atlas"}, {"start": 369, "audio": 0, "end": 704, "filename": "/assets/dancesdl.png"}, {"start": 704, "audio": 0, "end": 14085, "filename": "/assets/gamedata.txt"}, {"start": 14085, "audio": 0, "end": 167237, "filename": "/assets/Oswald.ttf"}, {"start": 167237, "audio": 0, "end": 1441633, "filename": "/assets/pixelmplus.ttf"}, {"start": 1441633, "audio": 0, "end": 1441843, "filename": "/assets/powerup1.png"}, {"start": 1441843, "audio": 0, "end": 1442053, "filename": "/assets/powerup5.png"}, {"start": 1442053, "audio": 0, "end": 1442206, "filename": "/assets/squarepowerupB .png"}, {"start": 1442206, "audio": 0, "end": 1442995, "filename": "/assets/texturepackerproj.tpproj"}, {"start": 1442995, "audio": 0, "end": 1461348, "filename": "/assets/titleimg.png"}, {"start": 1461348, "audio": 0, "end": 1461548, "filename": "/assets/wsq.png"}, {"start": 1461548, "audio": 1, "end": 1476454, "filename": "/assets/sounds/A.wav"}, {"start": 1476454, "audio": 1, "end": 1491360, "filename": "/assets/sounds/B.wav"}, {"start": 1491360, "audio": 1, "end": 2638115, "filename": "/assets/sounds/battlesong.ogg"}, {"start": 2638115, "audio": 1, "end": 2640856, "filename": "/assets/sounds/C.wav"}, {"start": 2640856, "audio": 1, "end": 2655762, "filename": "/assets/sounds/D.wav"}, {"start": 2655762, "audio": 1, "end": 2670668, "filename": "/assets/sounds/De.wav"}, {"start": 2670668, "audio": 1, "end": 2685574, "filename": "/assets/sounds/E.wav"}, {"start": 2685574, "audio": 1, "end": 2792406, "filename": "/assets/sounds/enemydamage.wav"}, {"start": 2792406, "audio": 1, "end": 3008878, "filename": "/assets/sounds/enemydead.wav"}, {"start": 3008878, "audio": 1, "end": 3072430, "filename": "/assets/sounds/enemyshoot.wav"}, {"start": 3072430, "audio": 1, "end": 3087336, "filename": "/assets/sounds/F.wav"}, {"start": 3087336, "audio": 1, "end": 3102242, "filename": "/assets/sounds/G.wav"}, {"start": 3102242, "audio": 1, "end": 3492786, "filename": "/assets/sounds/herodamage.wav"}], "remote_package_size": 3492786, "package_uuid": "6d65b586-fe88-4742-a116-c3c919fc48bf"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 580368,
    DYNAMIC_BASE = 5823248,
    DYNAMICTOP_PTR = 580208;
...
var ASM_CONSTS = {
 ...
 209316: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 210771: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 211760: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 211853: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 213078: function() {return screen.width;},  
 213105: function() {return screen.height;},  
 213178: function($0) {if (typeof Module['setWindowTitle'] !== 'undefined') { Module['setWindowTitle'](UTF8ToString($0)); } return 0;},  
 213332: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 213498: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 213724: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 214207: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
